...
def calcularLineaEspera():
    ...
    data2= dfLE.to_html(classes="table table-dark table-striped", justify="justify-all", border=0)
    ...
    data3 = dfLE2.to_html(classes="table table-dark table-striped", justify="justify-all", border=0)
...
def calcularMED():
    ...
    #datos.to_html()
    datohtml = datos.to_html(classes="table table-dark table-striped", justify="justify-all", border=0)
